...
export async function WorkersPageContent({ searchParams, readOnly = false }: WorkersPageContentProps) {
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground text-sm">
          {readOnly
            ...
            : 'View and manage all registered workforce personnel, job profiles, and active safety locations.'}
        </p>
      </div>
